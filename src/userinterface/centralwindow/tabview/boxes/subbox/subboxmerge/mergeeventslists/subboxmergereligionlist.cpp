#include "subboxmergereligionlist.h"

SubboxMergeReligionList::SubboxMergeReligionList(Kernel &k, Identifier &p) :
    BoxReligion (k, p)
{
    this->fill();
}

void SubboxMergeReligionList::fill()
{
    this->setTitle("");
...
void SubboxMergeReligionList::clickEdit(unsigned int index)
{
    emit reliChosen(index);
}
